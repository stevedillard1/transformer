...
Once you have a model that is worth testing, use generate.py to give the trained llm prompts. In the command line, run
    ...
    where <model_name> is the name under which the model was saved. For example, the model generated from trained_seinfeld_llm is called notebook_model.
